...
import (
	...
	"github.com/square/p2/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util"
	utilexec "github.com/square/p2/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/exec"
)
