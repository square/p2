...
// tree. Prior to this package, this is done through the consul.Store interface.
// The consul package is a hodge-podge of a lot of functionality for interacting
