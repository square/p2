...
func TestInitializeReplication(t *testing.T) {
	...
	// succeeded
	replication, _, err := replicator.InitializeReplication(false, false, 0)
	if err != nil {
...
func TestInitializeReplicationFailsIfNoPreparers(t *testing.T) {
	...
	_, _, testErr := replicator.InitializeReplication(false, false, 0)
	if testErr == nil {
...
func TestInitializeReplicationCanOverrideLocks(t *testing.T) {
	...
	replication, _, err := replicator.InitializeReplication(true, false, 0)
	if err != nil {
...
func TestInitializeReplicationWithManaged(t *testing.T) {
	...
	replication, _, err = replicator.InitializeReplication(false, true, 0)
	if err != nil {
