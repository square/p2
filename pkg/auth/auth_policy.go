...
// auth.Manifest mirrors store.Manifest, listing only the data
...
type FixedKeyringPolicy struct {
	...
	AuthorizedDeployers map[store.PodID][]string
}
...
// Specialized store make code self-documenting
type DpGroup string
